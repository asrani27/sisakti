...
@section('title', 'Tambah BKU - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Tambah BKU</h1>
        <p class="text-gray-400">Tambah Data Buku Kas Umum Perbulan</p>
    </div>

    <div class="card-gradient rounded-xl p-6">
        <form action="{{ route('upload.bku.store') }}" method="POST">
            @csrf
