...
@section('title', 'Tambah Anggaran Kas - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Tambah Anggaran Kas</h1>
        <p class="text-gray-400">Tambahkan data Dokumen Pelaksanaan Anggaran Kas baru</p>
    </div>

    <div class="card-gradient rounded-xl p-6">
        <form action="{{ route('upload.anggaran.store') }}" method="POST">
            @csrf
