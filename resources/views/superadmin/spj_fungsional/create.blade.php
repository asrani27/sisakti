...
@section('title', 'Tambah SPJ Fungsional - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Tambah SPJ Fungsional</h1>
        <p class="text-gray-400">Tambah data Surat Pertanggungjawaban Fungsional</p>
    </div>

    <div class="card-gradient rounded-xl p-6">
        <form action="{{ route('upload.spj-fungsional.store') }}" method="POST">
            @csrf
