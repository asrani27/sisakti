...
@section('title', 'Edit SKPD - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Edit SKPD</h1>
        <p class="text-gray-400">Edit Satuan Kerja Perangkat Daerah</p>
    </div>
        ...
        <form action="{{ route('skpd.update', $skpd->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_skpd" name="nama_skpd" value="{{ old('nama_skpd', $skpd->nama_skpd) }}"
                        class="w-full px-4 py-2 bg-slate-800/50 border-2 border-slate-700 rounded-lg text-gray-200 focus:border-indigo-500 focus:outline-none"
