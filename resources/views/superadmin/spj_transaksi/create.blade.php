...
@section('title', 'Tambah SPJ Transaksi - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Tambah SPJ Transaksi</h1>
        <p class="text-gray-400">Tambah data Surat Pertanggungjawaban Per Transaksi</p>
    </div>

    <div class="card-gradient rounded-xl p-6">
        <form action="{{ route('upload.spj-transaksi.store') }}" method="POST">
            @csrf
