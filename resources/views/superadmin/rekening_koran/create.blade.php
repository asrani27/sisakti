...
@section('title', 'Tambah Rekening Koran - SI SAKTI')

@section('content')
<div class="content-area">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Tambah Rekening Koran</h1>
        <p class="text-gray-400">Tambah data Rekening Koran baru</p>
    </div>
    ...
    <div class="card-gradient rounded-xl p-8">
        <form action="{{ route('rekening_koran.store') }}" method="POST">
            @csrf
                ...
                <div class="input-group transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <select id="skpd" name="kode_skpd" required
                            ...
                            <option value="{{ $skpd->kode_skpd }}" {{ old('kode_skpd') == $skpd->kode_skpd ? 'selected' : '' }}>
